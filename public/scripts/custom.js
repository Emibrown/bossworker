...
(function($){
    ...
    /*----------------------------------------------------*/ 
        ...
        $tabsNav.each(function() {
            ...
            $this.children('li').first().addClass('').stop(true,true).show();
        });

        $tabsNavLis.on('', function(e) {
            var $this = $(this);
    ...
    if (anchor.length === 0) {
        $(".tabs-nav li:first").addClass("").show(); //Activate first tab
    ...
    $(".sticky-header.cloned.transparent #logo a img").attr("src", "/images/bossworker.png");
